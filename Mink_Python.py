...
print '**************************************************'
print
print 'Minkowski Metric + + + - Geometric Product'
print 
...
print '**************************************************'
print
print 'Minkowski Metric + + + - Inner Product'
print 
AMV = a + b*ex + c*ey + d*ez + e*et + f*ex*ey + g*ex*ez + h*ex*et + i*ey*ez + j*ey*et + k*ez*et + l*ex*ey*ez + m*ex*ey*et + n*ex*ez*et + o*ey*ez*et + p*ex*ey*ez*et
AMV.Fmt(2,'AMV')
...
print '**************************************************'
print
print 'Minkowski Metric + + + - Left Contraction Product'
print 
AMV = a + b*ex + c*ey + d*ez + e*et + f*ex*ey + g*ex*ez + h*ex*et + i*ey*ez + j*ey*et + k*ez*et + l*ex*ey*ez + m*ex*ey*et + n*ex*ez*et + o*ey*ez*et + p*ex*ey*ez*et
AMV.Fmt(2,'AMV')
...
print '**************************************************'
print
print 'Minkowski Metric + + + - Right Contraction Product'
print 
AMV = a + b*ex + c*ey + d*ez + e*et + f*ex*ey + g*ex*ez + h*ex*et + i*ey*ez + j*ey*et + k*ez*et + l*ex*ey*ez + m*ex*ey*et + n*ex*ez*et + o*ey*ez*et + p*ex*ey*ez*et
AMV.Fmt(2,'AMV')
