...
istream &operator>>(istream &ff, Q &v) {
	return ff >> v.q >> v.xy >> v.yz >> v.xy;
}

istream &operator>>(istream &ff, O &v) {
	return ff >> v.q >> v.i  >> v.j  >> v.ij
		  >> v.E >> v.iE >> v.jE >> v.ijE;
}

istream &operator>>(istream &ff, CH &v) {
	return ff >> v.q >> v.x  >> v.y  >> v.xy
		  >> v.z >> v.xz >> v.yz >> v.xyz;
}

istream &operator>>(istream &ff, CO &v) {
	return ff >>
	v.q   >>  v.i    >>  v.j    >>  v.ij    >>  v.E    >>  v.iE    >>  v.jE    >>  v.ijE >> 
	v.xyz >>  v.xyzi >>  v.xyzj >>  v.xyzij >>  v.xyzE >>  v.xyziE >>  v.xyzjE >>  v.xyzijE;
}

istream &operator>>(istream &ff, HO &v) {
	return ff >> 
	v.q  >> v.i   >> v.j   >> v.ij   >> v.E   >> v.iE   >> v.jE   >> v.ijE   >> 
	v.xy >> v.xyi >> v.xyj >> v.xyij >> v.xyE >> v.xyiE >> v.xyjE >> v.xyijE >> 
	v.yz >> v.yzi >> v.yzj >> v.yzij >> v.yzE >> v.yziE >> v.yzjE >> v.yzijE >> 
	v.xz >> v.xzi >> v.xzj >> v.xzij >> v.xzE >> v.xziE >> v.xzjE >> v.xzijE;
}

istream &operator>>(istream &ff, CHO &v) {
	return ff >> 
	v.q   >> v.i    >> v.j    >> v.ij    >> v.E    >> v.iE    >> v.jE    >> v.ijE    >> 
	v.x   >> v.xi   >> v.xj   >> v.xij   >> v.xE   >> v.xiE   >> v.xjE   >> v.xijE   >> 
	v.y   >> v.yi   >> v.yj   >> v.yij   >> v.yE   >> v.yiE   >> v.yjE   >> v.yijE   >> 
	v.xy  >> v.xyi  >> v.xyj  >> v.xyij  >> v.xyE  >> v.xyiE  >> v.xyjE  >> v.xyijE  >> 
	v.z   >> v.zi   >> v.zj   >> v.zij   >> v.zE   >> v.ziE   >> v.zjE   >> v.zijE   >> 
	v.xz  >> v.xzi  >> v.xzj  >> v.xzij  >> v.xzE  >> v.xziE  >> v.xzjE  >> v.xzijE  >> 
	v.yz  >> v.yzi  >> v.yzj  >> v.yzij  >> v.yzE  >> v.yziE  >> v.yzjE  >> v.yzijE  >> 
	v.xyz >> v.xyzi >> v.xyzj >> v.xyzij >> v.xyzE >> v.xyziE >> v.xyzjE >> v.xyzijE;
}
...
ostream &operator<<(ostream &ff, CO &v) {
	return ff << "(" 
		<< v.q    << " , " << v.i     << " , " << v.j     << " , " << v.ij     << " , "
		<< v.E    << " , " << v.iE    << " , " << v.jE    << " , " << v.ijE    << " , " 
		<< v.xyz  << " , " << v.xyzi  << " , " << v.xyzj  << " , " << v.xyzij  << " , "
		<< v.xyzE << " , " << v.xyziE << " , " << v.xyzjE << " , " << v.xyzijE
	<< ")";
}
...
ostream &operator<<(ostream &ff, HO &v) {
	return ff << "(" 
		<< v.q   << " , " << v.i    << " , " << v.j    << " , " << v.ij    << " , "
		<< v.E   << " , " << v.iE   << " , " << v.jE   << " , " << v.ijE   << " , "
		<< v.xy  << " , " << v.xyi  << " , " << v.xyj  << " , " << v.xyij  << " , "
		<< v.xyE << " , " << v.xyiE << " , " << v.xyjE << " , " << v.xyijE << " , "
		<< v.yz  << " , " << v.yzi  << " , " << v.yzj  << " , " << v.yzij  << " , "
		<< v.yzE << " , " << v.yziE << " , " << v.yzjE << " , " << v.yzijE << " , "
		<< v.xz  << " , " << v.xzi  << " , " << v.xzj  << " , " << v.xzij  << " , "
		<< v.xzE << " , " << v.xziE << " , " << v.xzjE << " , " << v.xzijE
	<< ")";
}
...
ostream &operator<<(ostream &ff, CHO &v) {
	return ff << "(" 
		...
		<< v.E    << " , " << v.iE    << " , " << v.jE    << " , " << v.ijE    << " , "
		<< v.x    << " , " << v.xi    << " , " << v.xj    << " , " << v.xij    << " , "
		<< v.xE   << " , " << v.xiE   << " , " << v.xjE   << " , " << v.xijE   << " , "
		<< v.y    << " , " << v.yi    << " , " << v.yj    << " , " << v.yij    << " , "
		<< v.yE   << " , " << v.yiE   << " , " << v.yjE   << " , " << v.yijE   << " , "
		<< v.xy   << " , " << v.xyi   << " , " << v.xyj   << " , " << v.xyij   << " , "
		<< v.xyE  << " , " << v.xyiE  << " , " << v.xyjE  << " , " << v.xyijE  << " , "
		<< v.z    << " , " << v.zi    << " , " << v.zj    << " , " << v.zij    << " , "
		<< v.zE   << " , " << v.ziE   << " , " << v.zjE   << " , " << v.zijE   << " , "
		<< v.xz   << " , " << v.xzi   << " , " << v.xzj   << " , " << v.xzij   << " , "
		<< v.xzE  << " , " << v.xziE  << " , " << v.xzjE  << " , " << v.xzijE  << " , "
		<< v.yz   << " , " << v.yzi   << " , " << v.yzj   << " , " << v.yzij   << " , "
		<< v.yzE  << " , " << v.yziE  << " , " << v.yzjE  << " , " << v.yzijE  << " , "
...
C operator+(const C &a, const C &b) {
	...
	c.q   = a.q   + b.q;		c.xyz = a.xyz + b.xyz;

	c.q = expand(c.q) ; 		c.xyz = expand(c.xyz) ; 
...
Q operator+(const Q &a, const Q &b) {
	...
	c.q = expand(c.q) ; 	c.xy = expand(c.xy) ; 	c.yz = expand(c.yz) ; 	c.xz = expand(c.xz) ; 
...
O operator+(const O &a, const O &b) {
	...
	c.q = expand(c.q) ; 	c.i = expand(c.i) ; 	c.j = expand(c.j) ; 	c.ij = expand(c.ij) ; 
	c.E = expand(c.E) ; 	c.iE = expand(c.iE) ; 	c.jE = expand(c.jE) ; 	c.ijE = expand(c.ijE) ; 
...
CH operator+(const CH &a, const CH &b) {
	...
	c.q = expand(c.q) ; 	c.x = expand(c.x) ; 	c.y = expand(c.y) ; 	c.xy = expand(c.xy) ; 
	c.z = expand(c.z) ; 	c.xz = expand(c.xz) ; 	c.yz = expand(c.yz) ; 	c.xyz = expand(c.xyz) ; 
...
CO operator+(const CO &a, const CO &b) {
	...
	c.q = expand(c.q) ; 		c.i = expand(c.i) ; 		c.j = expand(c.j) ; 		c.ij = expand(c.ij) ; 
	c.E = expand(c.E) ; 		c.iE = expand(c.iE) ; 		c.jE = expand(c.jE) ; 		c.ijE = expand(c.ijE) ; 
	c.xyz = expand(c.xyz) ; 	c.xyzi = expand(c.xyzi) ; 	c.xyzj = expand(c.xyzj) ; 	c.xyzij = expand(c.xyzij) ; 
	c.xyzE = expand(c.xyzE) ; 	c.xyziE = expand(c.xyziE) ; 	c.xyzjE = expand(c.xyzjE) ; 	c.xyzijE = expand(c.xyzijE) ; 
...
HO operator+(const HO &a, const HO &b) {
	...
	c.q = expand(c.q) ; 		c.i = expand(c.i) ; 		c.j = expand(c.j) ; 		c.ij = expand(c.ij) ; 
	c.E = expand(c.E) ; 		c.iE = expand(c.iE) ; 		c.jE = expand(c.jE) ; 		c.ijE = expand(c.ijE) ; 
	c.xy = expand(c.xy) ; 		c.xyi = expand(c.xyi) ; 	c.xyj = expand(c.xyj) ; 	c.xyij = expand(c.xyij) ; 
	c.xyE = expand(c.xyE) ; 	c.xyiE = expand(c.xyiE) ; 	c.xyjE = expand(c.xyjE) ; 	c.xyijE = expand(c.xyijE) ; 
	c.yz = expand(c.yz) ; 		c.yzi = expand(c.yzi) ; 	c.yzj = expand(c.yzj) ; 	c.yzij = expand(c.yzij) ; 
	c.yzE = expand(c.yzE) ; 	c.yziE = expand(c.yziE) ; 	c.yzjE = expand(c.yzjE) ; 	c.yzijE = expand(c.yzijE) ; 
	c.xz = expand(c.xz) ; 		c.xzi = expand(c.xzi) ; 	c.xzj = expand(c.xzj) ; 	c.xzij = expand(c.xzij) ; 
	c.xzE = expand(c.xzE) ; 	c.xziE = expand(c.xziE) ; 	c.xzjE = expand(c.xzjE) ; 	c.xzijE = expand(c.xzijE) ; 
...
CHO operator+(const CHO &a, const CHO &b) {
	...
	c.q = expand(c.q) ; 		c.i = expand(c.i) ; 		c.j = expand(c.j) ; 		c.ij = expand(c.ij) ; 
	c.E = expand(c.E) ; 		c.iE = expand(c.iE) ; 		c.jE = expand(c.jE) ; 		c.ijE = expand(c.ijE) ; 
	c.x = expand(c.x) ; 		c.xi = expand(c.xi) ; 		c.xj = expand(c.xj) ; 		c.xij = expand(c.xij) ; 
	c.xE = expand(c.xE) ; 		c.xiE = expand(c.xiE) ; 	c.xjE = expand(c.xjE) ; 	c.xijE = expand(c.xijE) ; 
	c.y = expand(c.y) ; 		c.yi = expand(c.yi) ; 		c.yj = expand(c.yj) ; 		c.yij = expand(c.yij) ; 
	c.yE = expand(c.yE) ; 		c.yiE = expand(c.yiE) ; 	c.yjE = expand(c.yjE) ; 	c.yijE = expand(c.yijE) ; 
	c.xy = expand(c.xy) ; 		c.xyi = expand(c.xyi) ; 	c.xyj = expand(c.xyj) ; 	c.xyij = expand(c.xyij) ; 
	c.xyE = expand(c.xyE) ; 	c.xyiE = expand(c.xyiE) ; 	c.xyjE = expand(c.xyjE) ; 	c.xyijE = expand(c.xyijE) ; 
	c.z = expand(c.z) ; 		c.zi = expand(c.zi) ; 		c.zj = expand(c.zj) ; 		c.zij = expand(c.zij) ; 
	c.zE = expand(c.zE) ; 		c.ziE = expand(c.ziE) ; 	c.zjE = expand(c.zjE) ; 	c.zijE = expand(c.zijE) ; 
	c.xz = expand(c.xz) ; 		c.xzi = expand(c.xzi) ; 	c.xzj = expand(c.xzj) ; 	c.xzij = expand(c.xzij) ; 
	c.xzE = expand(c.xzE) ; 	c.xziE = expand(c.xziE) ; 	c.xzjE = expand(c.xzjE) ; 	c.xzijE = expand(c.xzijE) ; 
	c.yz = expand(c.yz) ; 		c.yzi = expand(c.yzi) ; 	c.yzj = expand(c.yzj) ; 	c.yzij = expand(c.yzij) ; 
	c.yzE = expand(c.yzE) ; 	c.yziE = expand(c.yziE) ;	c.yzjE = expand(c.yzjE) ;	c.yzijE = expand(c.yzijE) ; 
...
void PrintSimpleQ(const Q &a)
{
	...
	if(count == 0) printf(" 0     ");
	if((count<0) || (count>1)) Program_Failed("PrintSimpleQ - too many non-zero terms\n");
}
...
void Fill_Q_Basis(void) {
	...
	for(i=0;i<4;i++) Q_Basis[i] = Q();

	Q_Basis[ 0].q = +1;	Q_Basis[ 1].xy = +1;	Q_Basis[ 2].yz = +1;	Q_Basis[ 3].xz = +1;	
}	
...
void Fill_CHO_Basis(void) {
	...
	for(i=0;i<64;i++) CHO_Basis[i] = CHO();
...
C operator*(const C &a, const C &b) {
	...
	c.q   = + a.q*b.q - a.xyz*b.xyz;	c.xyz = + a.q*b.xyz + a.xyz*b.q;
...
CH operator*(const CH &a, const CH &b) {  // I am now using the GA3E formulas
...
CHO operator*(const CHO &a, const CHO &b) {  // I am now using the GA3EO formulas
...
void CHO_Zero_Grid(const CHO &a) {
	if (a.q == 0) printf("0 ");     else printf("x ");	if (a.i == 0) printf("0 ");      else printf("x ");
	if (a.j == 0) printf("0 ");     else printf("x ");	if (a.ij == 0) printf("0 ");     else printf("x ");
	if (a.E == 0) printf("0 ");     else printf("x ");	if (a.iE == 0) printf("0 ");     else printf("x ");
	if (a.jE == 0) printf("0 ");    else printf("x ");	if (a.ijE == 0) printf("0 ");    else printf("x ");
	printf("\n");
	if (a.x == 0) printf("0 ");     else printf("x ");	if (a.xi == 0) printf("0 ");     else printf("x ");
	if (a.xj == 0) printf("0 ");    else printf("x ");	if (a.xij == 0) printf("0 ");    else printf("x ");
	if (a.xE == 0) printf("0 ");    else printf("x ");	if (a.xiE == 0) printf("0 ");    else printf("x ");
	if (a.xjE == 0) printf("0 ");   else printf("x ");	if (a.xijE == 0) printf("0 ");   else printf("x ");
	printf("\n");
	if (a.y == 0) printf("0 ");     else printf("x ");	if (a.yi == 0) printf("0 ");     else printf("x ");
	if (a.yj == 0) printf("0 ");    else printf("x ");	if (a.yij == 0) printf("0 ");    else printf("x ");
	if (a.yE == 0) printf("0 ");    else printf("x ");	if (a.yiE == 0) printf("0 ");    else printf("x ");
	if (a.yjE == 0) printf("0 ");   else printf("x ");	if (a.yijE == 0) printf("0 ");   else printf("x ");
	printf("\n");
	if (a.xy == 0) printf("0 ");    else printf("x ");	if (a.xyi == 0) printf("0 ");    else printf("x ");
	if (a.xyj == 0) printf("0 ");   else printf("x ");	if (a.xyij == 0) printf("0 ");   else printf("x ");
	if (a.xyE == 0) printf("0 ");   else printf("x ");	if (a.xyiE == 0) printf("0 ");   else printf("x ");
	if (a.xyjE == 0) printf("0 ");  else printf("x ");	if (a.xyijE == 0) printf("0 ");  else printf("x ");
	printf("\n");
	if (a.z == 0) printf("0 ");     else printf("x ");	if (a.zi == 0) printf("0 ");     else printf("x ");
	if (a.zj == 0) printf("0 ");    else printf("x ");	if (a.zij == 0) printf("0 ");    else printf("x ");
	if (a.zE == 0) printf("0 ");    else printf("x ");	if (a.ziE == 0) printf("0 ");    else printf("x ");
	if (a.zjE == 0) printf("0 ");   else printf("x ");	if (a.zijE == 0) printf("0 ");   else printf("x ");
	printf("\n");
	if (a.xz == 0) printf("0 ");    else printf("x ");	if (a.xzi == 0) printf("0 ");    else printf("x ");
	if (a.xzj == 0) printf("0 ");   else printf("x ");	if (a.xzij == 0) printf("0 ");   else printf("x ");
	if (a.xzE == 0) printf("0 ");   else printf("x ");	if (a.xziE == 0) printf("0 ");   else printf("x ");
	if (a.xzjE == 0) printf("0 ");  else printf("x ");	if (a.xzijE == 0) printf("0 ");  else printf("x ");
	printf("\n");
	if (a.yz == 0) printf("0 ");    else printf("x ");	if (a.yzi == 0) printf("0 ");    else printf("x ");
	if (a.yzj == 0) printf("0 ");   else printf("x ");	if (a.yzij == 0) printf("0 ");   else printf("x ");
	if (a.yzE == 0) printf("0 ");   else printf("x ");	if (a.yziE == 0) printf("0 ");   else printf("x ");
	if (a.yzjE == 0) printf("0 ");  else printf("x ");	if (a.yzijE == 0) printf("0 ");  else printf("x ");
	printf("\n");
	if (a.xyz == 0) printf("0 ");   else printf("x ");	if (a.xyzi == 0) printf("0 ");   else printf("x ");
	if (a.xyzj == 0) printf("0 ");  else printf("x ");	if (a.xyzij == 0) printf("0 ");  else printf("x ");
	if (a.xyzE == 0) printf("0 ");  else printf("x ");	if (a.xyziE == 0) printf("0 ");  else printf("x ");
	if (a.xyzjE == 0) printf("0 "); else printf("x ");	if (a.xyzijE == 0) printf("0 "); else printf("x ");
	printf("\n");
}
...
void CH_Zero_Grid(const CH &a) {
	if (a.q == 0) printf("0 ");   else printf("x ");	if (a.x == 0) printf("0 ");    else printf("x ");
	if (a.y == 0) printf("0 ");   else printf("x ");	if (a.xy == 0) printf("0 ");   else printf("x ");
	if (a.z == 0) printf("0 ");   else printf("x ");	if (a.xz == 0) printf("0 ");   else printf("x ");
	if (a.yz == 0) printf("0 ");  else printf("x ");	if (a.xyz == 0) printf("0 ");  else printf("x ");
	printf("\n");
}
...
// g++ -Wall CHO_Routines.cp -l ginac -l cln
